...
export class VerifyTokenizedAssetRecordVCEndpoint
  implements IWebServiceEndpoint
{
  public static readonly CLASS_NAME = "VerifyTokenizedAssetRecordVCEndpoint";

  private readonly log: Logger;

  public get className(): string {
    return VerifyTokenizedAssetRecordVCEndpoint.CLASS_NAME;
  }
  ...
  public get oasPath(): (typeof OAS.paths)["/api/@hyperledger/cacti-asset-schema-architecture/registry/verify-tokenized-asset-record-vc"] {
    return OAS.paths[
  ...
  public async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    try {
      const tokenizedAssetRecordVC: TokenizedAssetRecordVerifiableCredential =
        req.body;
      const verificationResult: VerificationResult =
        await this.registryService.verifyTokenizedAssetRecordVC(
          tokenizedAssetRecordVC,
        );
      console.log(
        "Tokenized Asset Record VC verification result:",
        verificationResult,
      );
