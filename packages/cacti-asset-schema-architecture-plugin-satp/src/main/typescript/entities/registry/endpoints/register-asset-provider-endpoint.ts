...
export class RegisterAssetProviderEndpoint implements IWebServiceEndpoint {
  ...
  public get oasPath(): (typeof OAS.paths)["/api/@hyperledger/cacti-asset-schema-architecture/registry/register-asset-provider"] {
    return OAS.paths[
      "/api/@hyperledger/cacti-asset-schema-architecture/registry/register-asset-provider"
    ];
  }
