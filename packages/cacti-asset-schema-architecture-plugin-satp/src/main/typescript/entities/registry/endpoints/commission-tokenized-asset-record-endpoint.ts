...
{
  public static readonly CLASS_NAME = "CommissionTokenizedAssetRecordEndpoint";
  ...
  public get oasPath(): (typeof OAS.paths)["/api/@hyperledger/cacti-asset-schema-architecture/registry/commission-tokenized-asset-record"] {
    return OAS.paths[
      "/api/@hyperledger/cacti-asset-schema-architecture/registry/commission-tokenized-asset-record"
    ];
  }
