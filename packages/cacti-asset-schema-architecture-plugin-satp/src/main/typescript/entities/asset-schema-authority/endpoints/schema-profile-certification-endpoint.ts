...
export class SchemaProfileCertificationEndpoint implements IWebServiceEndpoint {
  ...
  public get className(): string {
    return SchemaProfileCertificationEndpoint.CLASS_NAME;
  }
  ...
  public get oasPath(): (typeof OAS.paths)["/api/@hyperledger/cacti-asset-schema-architecture/asset-schema-authority/schema-profile-certification"] {
    return OAS.paths[
      "/api/@hyperledger/cacti-asset-schema-architecture/asset-schema-authority/schema-profile-certification"
    ];
  }
