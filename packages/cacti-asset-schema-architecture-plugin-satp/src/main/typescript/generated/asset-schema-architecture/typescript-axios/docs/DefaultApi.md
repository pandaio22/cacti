...
> CommissionAssetSchema200Response commissionAssetSchema(assetSchemaCertification200Response)
...
let assetSchemaCertification200Response: AssetSchemaCertification200Response; //
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **assetSchemaCertification200Response** | **AssetSchemaCertification200Response**|  | |
...
> CommissionSchemaProfile200Response commissionSchemaProfile(schemaProfileCertification200Response)
...
let schemaProfileCertification200Response: SchemaProfileCertification200Response; //
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **schemaProfileCertification200Response** | **SchemaProfileCertification200Response**|  | |
...
# **getAssetSchema**
> AssetSchemaCertification200Response getAssetSchema()
...
# **getSchemaProfile**
> SchemaProfileCertification200Response getSchemaProfile()
