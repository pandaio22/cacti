# SchemaProfileVerifiableCredentialCredentialSubject
...
```typescript
import { SchemaProfileVerifiableCredentialCredentialSubject } from './api';

const instance: SchemaProfileVerifiableCredentialCredentialSubject = {
    id,
    name,
    version,
    hash,
