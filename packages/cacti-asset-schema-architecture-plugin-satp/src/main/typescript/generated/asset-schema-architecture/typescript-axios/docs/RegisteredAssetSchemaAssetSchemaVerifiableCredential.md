# RegisteredAssetSchemaAssetSchemaVerifiableCredential
...
```typescript
import { RegisteredAssetSchemaAssetSchemaVerifiableCredential } from './api';

const instance: RegisteredAssetSchemaAssetSchemaVerifiableCredential = {
    context,
    id,
    type,
    issuer,
