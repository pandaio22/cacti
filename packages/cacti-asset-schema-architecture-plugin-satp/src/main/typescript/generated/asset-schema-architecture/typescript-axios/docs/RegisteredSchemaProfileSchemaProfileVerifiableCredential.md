# RegisteredSchemaProfileSchemaProfileVerifiableCredential
...
```typescript
import { RegisteredSchemaProfileSchemaProfileVerifiableCredential } from './api';

const instance: RegisteredSchemaProfileSchemaProfileVerifiableCredential = {
    context,
    id,
    type,
    issuer,
