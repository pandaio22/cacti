# AssetSchemaCertificationRequestAssetSchemaDidDocumentVerificationMethodInner
...
```typescript
import { AssetSchemaCertificationRequestAssetSchemaDidDocumentVerificationMethodInner } from './api';

const instance: AssetSchemaCertificationRequestAssetSchemaDidDocumentVerificationMethodInner = {
    id,
    type,
    controller,
    publicKeyMultibase,
