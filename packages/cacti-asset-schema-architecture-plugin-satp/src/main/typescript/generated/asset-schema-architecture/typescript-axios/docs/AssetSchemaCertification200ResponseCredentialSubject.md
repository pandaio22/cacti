# AssetSchemaCertification200ResponseCredentialSubject
...
```typescript
import { AssetSchemaCertification200ResponseCredentialSubject } from './api';

const instance: AssetSchemaCertification200ResponseCredentialSubject = {
    id,
    name,
    version,
    hash,
