# RegisteredTokenizedAssetRecordTokenizedAssetRecordVerifiableCredential
...
```typescript
import { RegisteredTokenizedAssetRecordTokenizedAssetRecordVerifiableCredential } from './api';

const instance: RegisteredTokenizedAssetRecordTokenizedAssetRecordVerifiableCredential = {
    context,
    id,
    type,
    issuer,
