...
**credentialSubject** | [**CommissionSchemaProfileRequestSchemaProfileVerifiableCredentialCredentialSubject**](CommissionSchemaProfileRequestSchemaProfileVerifiableCredentialCredentialSubject.md) |  | [optional] [default to undefined]
...
```typescript
import { CommissionSchemaProfileRequestSchemaProfileVerifiableCredential } from './api';

const instance: CommissionSchemaProfileRequestSchemaProfileVerifiableCredential = {
    context,
    id,
    type,
    issuer,
