# SchemaProfileCertificationRequestSchemaProfileDidDocumentVerificationMethodInner
...
```typescript
import { SchemaProfileCertificationRequestSchemaProfileDidDocumentVerificationMethodInner } from './api';

const instance: SchemaProfileCertificationRequestSchemaProfileDidDocumentVerificationMethodInner = {
    id,
    type,
    controller,
    publicKeyMultibase,
