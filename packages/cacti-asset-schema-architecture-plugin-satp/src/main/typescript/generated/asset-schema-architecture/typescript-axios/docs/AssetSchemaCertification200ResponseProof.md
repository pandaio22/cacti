# AssetSchemaCertification200ResponseProof
...
```typescript
import { AssetSchemaCertification200ResponseProof } from './api';

const instance: AssetSchemaCertification200ResponseProof = {
    type,
    verificationMethod,
    created,
    proofPurpose,
