# CommissionAssetSchemaRequestAssetSchemaDidDocumentVerificationMethodInner
...
```typescript
import { CommissionAssetSchemaRequestAssetSchemaDidDocumentVerificationMethodInner } from './api';

const instance: CommissionAssetSchemaRequestAssetSchemaDidDocumentVerificationMethodInner = {
    id,
    type,
    controller,
    publicKeyMultibase,
