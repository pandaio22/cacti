# AssetSchemaCertificationRequestAssetSchemaDidDocument
...
**verificationMethod** | [**Array&lt;AssetSchemaCertificationRequestAssetSchemaDidDocumentVerificationMethodInner&gt;**](AssetSchemaCertificationRequestAssetSchemaDidDocumentVerificationMethodInner.md) |  | [default to undefined]
...
```typescript
import { AssetSchemaCertificationRequestAssetSchemaDidDocument } from './api';

const instance: AssetSchemaCertificationRequestAssetSchemaDidDocument = {
    context,
    id,
    type,
    verificationMethod,
