# CommissionSchemaProfileRequestSchemaProfileDidDocumentVerificationMethodInner
...
```typescript
import { CommissionSchemaProfileRequestSchemaProfileDidDocumentVerificationMethodInner } from './api';

const instance: CommissionSchemaProfileRequestSchemaProfileDidDocumentVerificationMethodInner = {
    id,
    type,
    controller,
    publicKeyMultibase,
