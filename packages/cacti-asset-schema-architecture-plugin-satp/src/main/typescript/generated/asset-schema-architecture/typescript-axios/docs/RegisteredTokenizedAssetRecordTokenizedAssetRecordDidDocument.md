# RegisteredTokenizedAssetRecordTokenizedAssetRecordDidDocument
...
```typescript
import { RegisteredTokenizedAssetRecordTokenizedAssetRecordDidDocument } from './api';

const instance: RegisteredTokenizedAssetRecordTokenizedAssetRecordDidDocument = {
    context,
    id,
    type,
    verificationMethod,
