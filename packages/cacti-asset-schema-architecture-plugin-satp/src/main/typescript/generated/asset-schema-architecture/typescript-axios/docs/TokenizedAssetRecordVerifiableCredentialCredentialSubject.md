# TokenizedAssetRecordVerifiableCredentialCredentialSubject
...
```typescript
import { TokenizedAssetRecordVerifiableCredentialCredentialSubject } from './api';

const instance: TokenizedAssetRecordVerifiableCredentialCredentialSubject = {
    id,
    name,
    version,
    hash,
