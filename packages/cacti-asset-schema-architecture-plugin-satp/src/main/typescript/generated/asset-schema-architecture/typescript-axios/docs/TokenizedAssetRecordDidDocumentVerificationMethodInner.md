# TokenizedAssetRecordDidDocumentVerificationMethodInner
...
```typescript
import { TokenizedAssetRecordDidDocumentVerificationMethodInner } from './api';

const instance: TokenizedAssetRecordDidDocumentVerificationMethodInner = {
    id,
    type,
    controller,
    publicKeyMultibase,
