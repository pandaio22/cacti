# SchemaProfileCertificationRequestSchemaProfileDidDocument
...
```typescript
import { SchemaProfileCertificationRequestSchemaProfileDidDocument } from './api';

const instance: SchemaProfileCertificationRequestSchemaProfileDidDocument = {
    context,
    id,
    type,
    verificationMethod,
